...
const SPECIALS=['nebelwisp'];
SPECIALS.forEach(id=>{DEX_ORDER.push(id);FAMILY_OF[id]=id;});
const STARTERS=['flamko','aquappi','blattli'];

const LEARNSETS={
  flamko:[[1,'rempler'],[1,'flammenwurf'],[6,'glutstoss'],[10,'krallenhieb'],[14,'glutwelle'],[18,'kampfschrei'],[22,'steinwurf'],[26,'kraftschlag'],[32,'infernoklinge'],[38,'hitzeschild'],[44,'wuchtstoss']],
  ...
  brockel:[[1,'rempler'],[1,'steinwurf'],[6,'steinstaub'],[10,'krallenhieb'],[14,'felslawine'],[18,'panzerung'],[22,'flammenwurf'],[26,'kraftschlag'],[32,'bergsturz'],[38,'einschuechtern'],[44,'wuchtstoss']],
  spuki:[[1,'rempler'],[1,'spukschlag'],[6,'schattenzehr'],[10,'krallenhieb'],[14,'schattenkralle'],[18,'fluch'],[22,'gifthieb'],[26,'kraftschlag'],[32,'seelenriss'],[38,'giftwolke'],[44,'wuchtstoss']],
  ...
  flatterix:[[1,'rempler'],[1,'windstoss'],[6,'einschuechtern'],[10,'luftwirbel'],[14,'sturmflug'],[18,'kampfschrei'],[22,'krallenhieb'],[26,'kraftschlag'],[32,'orkanschlag'],[38,'eiswind'],[44,'wuchtstoss']],
  draklin:[[1,'rempler'],[1,'drachenklaue'],[6,'krallenhieb'],[10,'einschuechtern'],[16,'drachenstoss'],[20,'flammenwurf'],[24,'drachentanz'],[28,'kraftschlag'],[34,'drachensturm'],[40,'glutwelle'],[46,'wuchtstoss']],
  erzling:[[1,'rempler'],[1,'metallklaue'],[6,'steinstaub'],[10,'krallenhieb'],[15,'stahlschlag'],[19,'stahlpanzer'],[23,'steinwurf'],[28,'kraftschlag'],[33,'erzsturm'],[39,'felslawine'],[45,'wuchtstoss']],
  faustli:[[1,'rempler'],[1,'fausthieb'],[6,'konter'],[10,'krallenhieb'],[14,'wirbelschlag'],[18,'ausholer'],[22,'steinwurf'],[26,'kraftschlag'],[32,'titanenfaust'],[38,'panzerung'],[44,'wuchtstoss']],
...
const MAPS=[
 {rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........GG.........T','T...VV,,,.PP.....VV..T','T.TT..,,,.PP.........T','T.TT......PP..WW..O..T','T.T...MMM.PP..WW.....T','T.C...MMM.PPP.WW.....T','T.....MOM.PPP.WWWW...T','T.........PPPPPKKPW..T','T.TT.P....PP..WW.WW..T','T.TTUPM..PPP..WWWWW..T','T.T..P...PP...WW.,,,.T','T....CVV.PP...WW.,,,.T','T...TTU..PP..........T','T..,T,...PPP.........T','T..,,,...PPP.........T','T.........PP.........T','TTTTTTTTTTTTTTTTTTTTTT'],
  spawn:[10,16],trainers:[[4,4],[17,4],[5,9],[16,9],[8,13]],boss:[10,2],rival:[13,13]},
 {rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........PP.........T','T.TT......PP.....TTT.T','T.TTT..,,,PP...O..TT.T','T.T....O,,PPP........T','T....U.,,,PPP..U.....T','T.........PPP...U.TT.T','T.TT..O...PP......TT.T','T.TT.....PPP.........T','T..C..P..PP......T...T','T...T.P..PPPP........T','T.....P..PPPP,,,..TT.T','T.TT..M...PPP,,,..T..T','T.T..U....PP..,,.....T','T........PPP....TT...T','T...TT,,.PP..........T','T....,,,.PPS.........T','TTTTTTTTTTTTTTTTTTTTTT'],
  spawn:[10,16],trainers:[[4,4],[17,4],[6,9],[15,10],[8,13]],boss:[10,2],rival:[13,13],legend:[19,15]},
 {rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........PP.........T','T.....,,,.PP.....O...T','T.....,,,.PP.O.WWWWW.T','T.WWW....PPP...WWWWW.T','T.WWW.U..PP...UWWWWW.T','T.WWW....PPP...WWWWW.T','T.....MM.PPP..KKKWWW.T','T..O..MM..PPP.KKKWWW.T','T....MM...PPP..WWWWW.T','T..U......PPP..WWWWW.T','T.WWW.....PP...WWWWW.T','T.WWW.U..PPP...WWWWW.T','T.WWW.,,,PP....WWWWW.T','T.....,,,PPP.O.WWWWW.T','T.....,,,PPPC..WWWWW.T','T.........PP.........T','TTTTTTTTTTTTTTTTTTTTTT'],
  spawn:[10,16],trainers:[[5,4],[13,4],[5,10],[13,9],[6,13]],boss:[10,2],rival:[12,12]},
 {rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........PP.........T','T.....,,,.PP.,,,,....T','T...VV,,,.PP.,,,,VV..T','T.....U,,.PP.,,O,....T','T.........PP.........T','T.........PP.........T','T..O.....VPPPP....O..T','T.........PPPP.......T','T.........PPPP.......T','T.........PPV........T','T........PPP....,,,,.T','T.,,,,...PP.....VV,,.T','T.,,VV...PPP...U,,,,.T','T.,,,,O..PPP....,,,,.T','T.,,,,....PP.........T','T.........PP.........T','TTTTTTTTTTTTTTTTTTTTTT'],
  spawn:[10,16],trainers:[[5,4],[16,4],[3,9],[18,9],[6,13]],boss:[10,2],rival:[15,12],legend:[2,13]},
 {rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........PP.........T','T.........PP.........T','T.O.......PP.......O.T','T..O......PP...LL.O..T','T......O..PP...LLLL..T','T.........PP...LLLL..T','T..LLLL...PP.........T','T..LLLL...PPP........T','T..LLLL...PPP........T','T........PPPP........T','T........PPP..LLL.L..T','T.......PPP...LLLLL..T','T.......PP....LLLLL..T','T...O...PPPP.......O.T','T.O.....PPPP.O.......T','T.........PP.........T','TTTTTTTTTTTTTTTTTTTTTT'],
  spawn:[10,16],trainers:[[4,4],[17,4],[8,6],[13,6],[4,11]],boss:[10,2],rival:[17,11]},
 {rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........PP.........T','T..,,,....PP.........T','T..,,,....PP.O.......T','T..,,,...PPP....OO...T','T..WWWW..PP.....O....T','T..WWWKK.PPPP........T','T..WWWW..PPPP.....U..T','T.........PPP........T','T.........PP...WWWW..T','T...OO..PPPP...KKWW..T','T...O...PPP....WWWW..T','T.......PPPP...WWW...T','T.....U.OPPP...,,,,..T','T........PPP..U,,,,..T','T........PP....,,,,..T','T........PPS.........T','TTTTTTTTTTTTTTTTTTTTTT'],
  spawn:[10,16],trainers:[[3,3],[18,3],[7,6],[14,6],[3,12]],boss:[10,2],rival:[18,12],legend:[2,15]},
 {rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........PP.........T','T.........PP.........T','T.TT...VV.PP......TT.T','T.T......PPP..WWW..T.T','T.....O..PP...WKKO...T','T........PPP..WWWW...T','T...TT...PPP..WWWW...T','T.........PPP........T','T.........PPP........T','T........PPPP...TT...T','T........PPP.........T','T.TT....PPP.......TT.T','T.......PP..CVVO.....T','T...O...PPPP.........T','T.......PPPP.........T','T.........PP.........T','TTTTTTTTTTTTTTTTTTTTTT'],
  spawn:[10,16],trainers:[[4,4],[17,4],[8,6],[13,6],[4,11]],boss:[10,2],rival:[17,11]},
 {rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........PP.........T','T.........PP.........T','T..O......PP......O..T','T.........PP.........T','T........VPPV........T','T.........PP.........T','T.....O...PP...O.....T','T.........PP.........T','T.........PP.........T','T.....O..PPP...O.....T','T........PP..........T','T........VP.V........T','T........PPP.........T','T..O.....PPP......O..T','T.........PP.........T','T.........PP.........T','TTTTTTTTTTTTTTTTTTTTTT'],
...
const ARENA_DEFS=[
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[6,10],[15,10],[10,6]],boss:[10,2]},
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFBBFFBBFFFFBBFFBBFFB','BFFBBFFBBFFFFBBFFBBFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFBBFFBBFFFFBBFFBBFFB','BFFBBFFBBFFFFBBFFBBFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFBBFFBBFFFFBBFFBBFFB','BFFBBFFBBFFFFBBFFBBFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[6,10],[15,10],[10,6]],boss:[10,2]},
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFYYYYFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFXFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[6,10],[15,10],[10,6]],boss:[10,2]},
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFF^FFFB','BFFFFFFFFFFFFFFFF^FFFB','BFFFFF>v>v>v>v>vFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[6,10],[15,10],[10,6]],boss:[10,2]},
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFLLLLLLFFFFFFFFFFFFB','BFFLLLFLLFFFFFFFFFFFFB','BFFLLLFLLFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFLLFLLLFFB','BFFFFFFFFFFFFLLFLLLFFB','BFFFFFFFFFFFFLLFLLLFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[6,10],[15,10],[10,6]],boss:[10,2]},
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFOOFFFFFFFFFFFFOOFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFOOFFOOFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFOOFFOOFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFOOFFFFFFFFFFFFOOFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[6,10],[15,10],[10,6]],boss:[10,2]},
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFIIIIIIIIIIIIIIFFFB','BFFFIIIIIIIIIIIIIIFFFB','BFFFIIIIIFFFFIIIIIFFFB','BFFFIIIIIIIIIIIIIIFFFB','BFFFIIIIIIIIIIIIIIFFFB','BFFFIIIIIIIIIIIIIIFFFB','BFFFIIFIIIIIIIIFIIFFFB','BFFFIIIIIIIIIIIIIIFFFB','BFFFIIIIIIIIIIIIIIFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[6,10],[15,10],[10,6]],boss:[10,2]},
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFOFFFFFFFFOFFFFFB','BFFFFFFFFFIIFFFFFFFFFB','BFFFFFFFFFIIFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFOFFFFFFFFOFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFOFFOFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[10,14],[6,11],[14,11],[6,5],[14,5]],boss:[10,2]}
];
...
const NPC_DATA=[
 [{n:'Alte Marta',t:['Willkommen in Mooshain!','Im Rasthaus links wirst du geheilt – und kannst einkaufen.','Die Halle rechts prüft, ob du zum Weiterziehen bereit bist.'],
  ...
  {n:'Händler Kurt',t:['Nimm das, für den Anfang.','Wirf die Kugel erst, wenn der Gegner kaum noch Kraft hat.'],gift:'superkugel',n2:3,
 ...
 [{n:'Förstersfrau Ida',t:['Der Wald verschluckt Geräusche – und manchmal ganze Kryptiden.','Geist-Attacken prallen an Normal-Kryptiden völlig ab. Umgekehrt genauso.'],
  ...
  {n:'Kräutersammler Jo',t:['Hier, gegen Gift und Lähmung.','Statusprobleme verschwinden nicht von selbst im Kampf.'],gift:'gegenmittel',n2:3,
  ...
  {n:'Kind Pim',t:['Im hohen Gras verstecken sich manchmal scheue Kryptiden!','Die hauen nach zwei Runden ab. Man muss schnell sein.'],
   chat:['Ich habe mal ein Spuki gesehen! Ehrlich!','Erzähl mir, wenn du was Seltenes gefangen hast, ja?']}],
 ...
 [{n:'Seherin Alma',t:['Nimm diese Rolle, Wanderer.','Sturmruf steigert die Initiative. Keine andere Attacke tut das.'],gift:'r_sturm',n2:1,
  ...
  {n:'Irrlicht-Jäger Ru',t:['Vergiftung frisst jede Runde an den Kräften.','Gegen zähe Gegner ist das oft besser als roher Schaden.'],
   chat:['Ich jage die Lichter schon seit Jahren – gefangen habe ich noch keins.','Manche sagen, die Irrlichter jagen eigentlich mich.']},
 ...
 [{n:'Torwächterin Vala',t:['Die Liga-Halle nimmt nur Meister auf.','Fünf Meister, keine Pause. Deine AP füllen sich nicht zwischendurch.'],
  ...
  {n:'Heilerin Sona',t:['Nimm das. Weiter kann ich dir nicht helfen.','Ab hier zählt nur noch dein Team.'],gift:'hyperkugel',n2:5,
...
const AREA_DEFS=[
  {name:'Mooswiese',cap:12,style:{grass:'#8fce7a',grass2:'#83c46e',tall:'#5faa52',tall2:'#4e9648',path:'#e2cda6',water:'#4a7fc1',tree:'#2e6338',tree2:'#3c7a46',trunk:'#5a4632',sky1:'#bfe6f5',sky2:'#8fce7a'},
   roster:['flamko','aquappi','blattli','flatterix'],boss:'Wiesenwart Bruno',ambient:['fireflies','leaves','butterflies']},
  {name:'Flüsterwald',cap:18,style:{grass:'#79b869',grass2:'#6fae5f',tall:'#4e9648',tall2:'#3f7d3a',path:'#cdb488',water:'#3f6fa8',tree:'#245028',tree2:'#2e6338',trunk:'#4a3826',sky1:'#a8ceb0',sky2:'#79b869'},
   roster:['blattli','spuki','giftling','flatterix'],boss:'Waldläuferin Mira',ambient:['fog','rays','leaves']},
  {name:'Kristallküste',cap:24,style:{grass:'#8fd0b8',grass2:'#84c6ae',tall:'#4aa88c',tall2:'#3f9a7e',path:'#ece0b8',water:'#3f92c9',tree:'#2e7a68',tree2:'#3a8a76',trunk:'#6a5a44',sky1:'#bfeaf5',sky2:'#8fd0b8'},
   roster:['aquappi','krabbo','zappzap','frosti'],boss:'Küstenkapitän Sören',weather:'regen',ambient:['rain']},
  {name:'Donnersteppe',cap:30,style:{grass:'#cfc684',grass2:'#c4ba78',tall:'#a89a4a',tall2:'#988a3e',path:'#e2ceA0',water:'#4a7fc1',tree:'#7a7040',tree2:'#8a8050',trunk:'#5a4632',sky1:'#f0dfa8',sky2:'#cfc684'},
   roster:['zappzap','flatterix','faustli','flamko'],boss:'Steppenreiterin Ilka',weather:'sturm',ambient:['dust','butterflies']},
  {name:'Aschekrater',cap:36,style:{grass:'#c98a6a',grass2:'#bd8060',tall:'#a85a3a',tall2:'#984e30',path:'#8a6a55',water:'#c25a3a',tree:'#6a4030',tree2:'#7a4c38',trunk:'#4a2c20',sky1:'#e8a878',sky2:'#c98a6a'},
   roster:['flamko','brockel','erzling','faustli'],boss:'Kraterhexe Glut',weather:'sonne',ambient:['ash','rays']},
  {name:'Nebelmoor',cap:42,style:{grass:'#8a86b0',grass2:'#807ca6',tall:'#5a568c',tall2:'#4e4a7e',path:'#6f6a94',water:'#4a4a7a',tree:'#3a3660',tree2:'#46426e',trunk:'#2e2a48',sky1:'#a8a4c8',sky2:'#8a86b0'},
   roster:['spuki','giftling','draklin','frosti'],boss:'Moorgeist Nebula',weather:'nebel',ambient:['fog','irrlichter']},
  {name:'Felsenpass',cap:48,style:{grass:'#b8ae98',grass2:'#aca28c',tall:'#8a7f6d',tall2:'#7a6f5d',path:'#cfbfa0',water:'#5a8ab8',tree:'#6a6050',tree2:'#7a7060',trunk:'#4a4238',sky1:'#d8cfc0',sky2:'#b8ae98'},
   roster:['brockel','erzling','draklin','faustli'],boss:'Felsvogt Granit',weather:'schnee',ambient:['snow']},
...
const state={team:[],box:[],leadIdx:0,bag:{kugel:5,trank:2},money:600,
  ...
  events:[],npcSeen:[],legendClues:[],quests:{},sideId:null,
...
const QUESTS=[
  {id:'q0',area:0,npcIdx:1,name:'Mut zum Fangen',
   ...
   remind:'Hast du schon dein eigenes Blattli gefangen? Zeig es mir, wenn es so weit ist!',
   check:()=>state.caught.some(id=>FAMILY_OF[id]==='blattli'),
   progress:()=>state.caught.some(id=>FAMILY_OF[id]==='blattli')?'Blattli gefangen ✓':'Noch kein Blattli gefangen',
   complete:'Du hast wirklich eins gefangen – und behältst es natürlich, es ist ja deins! Aber jetzt weiß ich, dass es geht. Hier, das hat meine Oma mir gegeben. Sie sagte, es sei für "etwas Besonderes". Vielleicht weißt du, wofür.',
  ...
  {id:'q2',area:2,npcIdx:3,name:'Das Wesen im Riff',
   ...
   remind:'Schon ein Krabbo gefangen? Die Scheren erkennt man sofort.',
   check:()=>state.caught.some(id=>FAMILY_OF[id]==='krabbo'),
   progress:()=>state.caught.some(id=>FAMILY_OF[id]==='krabbo')?'Krabbo gefangen ✓':'Noch kein Krabbo gefangen',
  ...
  {id:'q5',area:5,npcIdx:3,name:'Das Echo im Nebel',
   ...
   progress:()=>legendClueCount(5)+'/3 Hinweise gefunden (Gerücht, Spur, Licht)',
  ...
  {id:'q6',area:6,npcIdx:1,name:'Kind des Schneefalls',
   ...
   remind:'Schon ein Frosti gefangen?',
   check:()=>state.caught.some(id=>FAMILY_OF[id]==='frosti'),
   progress:()=>state.caught.some(id=>FAMILY_OF[id]==='frosti')?'Frosti gefangen ✓':'Noch kein Frosti gefangen',
  ...
  {id:'q7',area:7,npcIdx:1,name:'Der erste Eintrag',
   ...
   legendGate:true,
   reward:{money:500,item:'hyperkugel',itemN:3}},
...
function questFor(area,npcIdx){return QUESTS.find(q=>q.area===area&&q.npcIdx===npcIdx);}
...
const SIDE_LINK={
  '0:2:6':'mooshain_steinkreis',
  '0:5:12':'mooshain_hoehle',
  '1:3:9':'fluesterwald_schreiberei',
  '2:12:15':'kristallkueste_wrack',
  '6:12:13':'felsenpass_aussicht'
};
const SIDE_AREAS={
  mooshain_steinkreis:{
    name:'Alter Steinkreis',parentArea:0,returnPos:[2,7],
  ...
  mooshain_hoehle:{
    name:'Kleine Höhle',parentArea:0,returnPos:[5,13],
  ...
  fluesterwald_schreiberei:{
    name:'Verlassene Schreiberei',parentArea:1,returnPos:[3,10],
  ...
  felsenpass_aussicht:{
    name:'Aussichtspunkt',parentArea:6,returnPos:[12,14],
...
function snapshot(){
  return{v:6,team:state.team,box:state.box,leadIdx:state.leadIdx,bag:state.bag,money:state.money,
    ...
    events:state.events,npcSeen:state.npcSeen,legendClues:state.legendClues,quests:state.quests,sideId:state.sideId,
...
function applySave(s){
  ...
  state.events=s.events||[];state.npcSeen=s.npcSeen||[];state.legendClues=s.legendClues||[];state.quests=s.quests||{};state.sideId=s.sideId||null;
...
async function initTitle(){
  ...
  STARTERS.forEach(id=>{
    ...
    state.loc='stadt';
    state.pendingLearn=[];state.pendingEvo=[];state._equip=null;state.area=0;state.champion=false;state.dexRewards=[];
      state.px=SPAWN_SUED[0];state.py=SPAWN_SUED[1];state.healed=false;
...
function locRows(){
  ...
  if(state.loc==='arena')return ARENA_DEFS[state.area].rows;
...
function npcAt(x,y){
  ...
  if(state.loc==='side'){
    ...
    for(let i=0;i<liste.length;i++){
      const p=liste[i].pos;
      if(p&&p[0]===x&&p[1]===y)return Object.assign({},liste[i],{idx:i,key:'side-'+state.sideId+'-'+i});
    }
    return null;
  }
  return null;
...
function activeLegend(){
  ...
  if(LEGEND_DATA[state.area]){
    if(legendClueCount(state.area)<LEGEND_CLUE_KINDS.length)return null;
...
function isBlocked(x,y){
  const t=tileAt(x,y);
  if(t==='T'||t==='W'||t==='B'||t==='O'||t==='U'||t==='L')return true;
...
function drawTile(t,sx,sy,gx,gy){
  ...
  switch(t){
    ...
    case 'T':{
      ...
      break;}
    case 'C':{   // Versteckter Zugang zu einem Nebenbereich
      wctx.fillStyle=base;wctx.fillRect(sx,sy,TILE+1,TILE+1);
...
function drawWorld(){
  ...
  wctx.fillText(locName()+'  Lv≤'+areaDef().cap+zusatz+'  💰'+state.money+(WW?'  '+WW.icon:''),5,11);
}
...
function runEvent(kind,x,y){
  ...
  if(kind==='spuren'){
    ...
    addItem('kugel',2);
    toast('🧳 Ein wandernder Händler kreuzt deinen Weg: "Nimm das, für unterwegs!" <b>+2 Fangkugeln</b>',3200);
  }else if(kind==='schatz'){
...
function eventPoolFor(a){
  ...
  if(LEGEND_DATA[a]&&legendClueCount(a)<LEGEND_CLUE_KINDS.length){
    const have=state.legendClues||[];
    if(have.indexOf(a+':spuren')<0)pool.push({kind:'legendspur',w:1.5});
    if(have.indexOf(a+':licht')<0)pool.push({kind:'legendlicht',w:1.5});
  }
  return pool;
}
...
function checkSidePickup(x,y){
  ...
  toast((pu.msg||('✨ Du findest: <b>'+(pu.item?ITEMS[pu.item].name:'etwas Interessantes')+'</b>!'))+bonus,3400);
  saveGame(true);
}
...
async function movePlayer(dx,dy){
  ...
  if(zt==='D'){
    if(state.loc==='side'){
      ...
      state.sideId=null;
      gotoLoc('route',pa,sa.returnPos,'◀ Zurück auf der Route');
    }else{
  ...
  if(state.loc==='route'&&tileAt(state.px,state.py)===','&&Math.random()<.2){startWildBattle();moveLock=false;return;}
  if(state.loc==='side'&&SIDE_AREAS[state.sideId]&&SIDE_AREAS[state.sideId].roster&&tileAt(state.px,state.py)==='F'&&Math.random()<.15){startWildBattle();moveLock=false;return;}
  maybeSpawnSighting();
  moveLock=false;
}
const NPC_PALS=[
...
function talkTo(np){
  ...
  btn.onclick=()=>{
    if(i>zeilen.length||(i===zeilen.length&&!geschenkText)){
      box.classList.add('hidden');dialogAktiv=false;return;
    }
    zeige();
  };
...
function nordAusgang(){
  if(state.loc==='stadt'){
    gotoLoc('route',state.area,SPAWN_SUED,
      '🛤️ Route '+(state.area+1)+' – hier warten Trainer und wilde Kryptiden.');
  }else if(state.loc==='route'){
...
function suedAusgang(){
  if(state.loc==='stadt'){
    if(state.area<=0){toast('Hier beginnt deine Reise – südlich geht es nicht weiter.');return;}
...
function renderActions(){
  ...
  $('btnFight').innerHTML='⚔️ Kampf<span class="mv-sub">'+
...
function showSelfInfo(idx){
  ...
  setMsg(
    `<div style="display:flex;align-items:baseline;gap:6px;flex-wrap:wrap">
       ...
       ${m===aktiv?'<span class="badge" style="background:#c94f6d">im Kampf</span>':''}
       ${m.hp<=0?'<span class="badge" style="background:#8a8298">kampfunfähig</span>':''}
  ...
  if(!istAktiv&&m.hp>0){
    ...
    hin.innerHTML='steht bereits im Kampf';
    g.appendChild(hin);
  }else{
    const hin=document.createElement('button');
    hin.className='secondary span2';hin.disabled=true;
    hin.innerHTML='kampfunfähig – kann nicht kämpfen';
    g.appendChild(hin);
  }
  setActions('sub');
}
...
async function doRound(action){
  ...
  for(const step of seq){
    ...
    if(step[0]==='p'){
      ...
      await applyMove(lead(),b.enemy(),step[1],true,step[2]);
      if(b.enemy().hp<=0)return enemyFaint();
    }else{
...
function shareXp(xp,active,only){
  ...
  (only||state.team).forEach(m=>{
    ...
    while(rest>0){
      ...
      refreshStats(m);
      if(warOhnmaechtig)m.hp=0;                       // bleibt kampfunfähig
...
function chooseDoubleMove(i){
  ...
  if(foes.length===1){b.orders.push({m,move:mv,target:foes[0],slot:i});promptNext();return;}
  const g=$('actionSub');g.innerHTML='';
...
function renderMenu(){
  ...
  if(tab==='team'){
    ...
    if(state._useItem){
      ...
      if(!passend.length){
        ...
        p2.textContent=it.kind==='heal'?'Alle Kryptiden haben volle KP.':
          it.kind==='cure'?'Niemand hat ein Statusproblem.':'Niemand ist kampfunfähig.';
        list.appendChild(p2);
      }
      passend.forEach(({m,i})=>{
    ...
    [['HEILUNG',['heal','cure','revive']],['FANGKUGELN',['ball']],['TRAGITEMS',['held']],
...
function showDexDetail(id){
  ...
  lore.innerHTML=(LORE[id]||'Noch keine Aufzeichnungen über dieses Kryptid.')+
    (caught?'':'<div style="margin-top:6px;opacity:.7;font-size:9px">Noch nicht gefangen – im Katalog nur gesehen.</div>');
