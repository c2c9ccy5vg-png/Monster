...
const SIDE_AREAS={
  ...
  donnersteppe_windmuehle:{
    ...
    guardian:{key:'kronenwaechter-windmuehle',pos:[6,4],name:'Wächter Ilvara',
  ...
  aschekrater_schmiede:{
    ...
    guardian:{key:'kronenwaechter-schmiede',pos:[10,9],name:'Wächter Bram',
  ...
  nebelmoor_ruinen:{
    ...
    guardian:{key:'kronenwaechter-ruinen',pos:[11,10],name:'Wächter Sylre',
  ...
  meisterstadt_archiv:{
    ...
    guardian:{key:'kronenwaechter-archiv',pos:[11,6],name:'Wächter Osk',
