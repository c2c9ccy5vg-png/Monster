...
const ARENA_DEFS=[
 ...
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BQQQQQQQQQQQQQQQQQQQQB','BQQQQQQQQQQQQQQQQQQQQB','BFFFFFFFFFFFFFFFFFFFFB','BRRRRRRRRRRRRRRRRRRRRB','BRRRRRRRRRRRRRRRRRRRRB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[6,3],[15,3],[10,12]],boss:[10,2]},
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','Bv<<<<<<<<^^^^^^^^^^FB','BvvFFFFFFFFFFFFFFFFF^B','BvvFFFFFFFFFFFFFFFFF^B','BvvFFFFFFFFFFFFFFFFF^B','BvvFFFFFFFFFFFFFFFFF^B','BvvFFFFFFFFFFFFFFFFF^B','BvvFFFFFFFFFFFFFFFFF^B','BvvFFFFFFFFFFFFFFFFF^B','BvvFFFFFFFFFFFFFFFFF^B','BvvFFFFFFFFFFFFFFFFF^B','Bvv<<<<<<<<<<<>>>>>>^B','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[6,10],[15,10],[10,6]],boss:[10,2]},
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BqqqqqqqqqqqqqqqqqqqqB','BqqqqqqqqqqqqqqqqqqqqB','BrrrrrrrrrrrrrrrrrrrrB','BrrrrrrrrrrrrrrrrrrrrB','BssssssssssssssssssssB','BssssssssssssssssssssB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[6,3],[15,3],[10,12]],boss:[10,2]},
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFJFFFFFFJFFFFFFB','BBBBBBEBBBBBBBBBBBBBBB','BFFJFFFFFFFFFFFFJFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BBBBBBBBBBBBBBBEBBBBBB','BFFFFFFFFJFFFFFFFFJFFB','BFFFFFFFFFFFFFFFFFFFFB','BBBBBBBBBBEBBBBBBBBBBB','BFFFJFFFFFFFFFFFFJFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[10,11],[10,7],[10,4]],boss:[10,2]},
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BIIIIIIIIIIIIIIIIIIIIB','BIIIIIIIIIIIIIIIIIIIIB','BIIIIIIFIIIIIIIFIIIIIB','BIIIIIIIIIIIIIIIIIIIIB','BIIIIFIIIIIIIIIIFIIIIB','BIIIIIIIIIIIIIIIIIIIIB','BIIIIIIIFIIIFIIIIIIIIB','BIIIIIIIIIIIIIIIIIIIIB','BIIIIFIIIIIIIIIIFIIIIB','BIIIIIIIIIIIIIIIIIIIIB','BIIIIIIIIIIIIIIIIIIIIB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[6,10],[15,10],[10,6]],boss:[10,2]},
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFOFFFFFFFFOFFFFFB','BIIIIIIIIIIIIIIIIIIIIB','BIIIIIIIIIIIIIIIIIIIIB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFOFFFFFFFFOFFFFFB','BQQQQQQQQQQQQQQQQQQQQB','BQQQQQQQQQQQQQQQQQQQQB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFOFFOFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
...
const SIDE_AREAS={
  ...
  mooshain_hoehle:{
    name:'Kleine Höhle',parentArea:0,returnPos:[5,12],cave:true,
  ...
  kristallkueste_wrack:{
    name:'Gestrandetes Wrack',parentArea:2,returnPos:[1,15],
  ...
  donnersteppe_windmuehle:{
    ...
    guardian:{key:'kronenwaechter-windmuehle',pos:[6,4],name:'Wächter Ilvara',lvl:30,
      team:[{id:'flatterlord',lvl:30}],pal:BOSS_PAL,
      intro:'Wächter Ilvara: "Wer diesen Splitter will, muss erst beweisen, dass er dem Himmel gewachsen ist."',
      win:'Wächter Ilvara: "...Gut. Nimm ihn. Er gehört ohnehin nicht mir."'},
    ...
    pickups:[{pos:[6, 3],item:'kronensplitter',qty:1,requireDefeated:'kronenwaechter-windmuehle',
      lockedMsg2:'🔒 Wächter Ilvara versperrt den Weg zum Splitter noch.',
  ...
  aschekrater_schmiede:{
    ...
    guardian:{key:'kronenwaechter-schmiede',pos:[10,9],name:'Wächter Bram',lvl:36,
      team:[{id:'flamgeddon',lvl:36}],pal:BOSS_PAL,
      intro:'Wächter Bram: "Die Esse glüht nicht für jeden. Zeig mir, dass dein Feuer heißer brennt."',
      win:'Wächter Bram: "Die Glut erkennt dich an. Nimm, was dir zusteht."'},
    rows:['TTTTTTTTTTTTTTTTTTTTTT','TTTTTTTTTTTTTTTTTTTTTT','TTTTTTTTTTTTTTTTTTTTTT','TLLLLLLLLLLLLLLLLTTTTT','TLLLLLLLLLLLLLLLLTTTTT','TLLLLLLLLLLLLLLLLTTTTT','TLLLLLLLLLLLLLLLLTTTTT','TLLLL............TTTTT','TTTTT....O...O...TTTTT','TTTTT............TTTTT','TLLLL............LLLLT','TLLLL....O...O...LLLLT','TLLLL............LLLLT','TLLLL............LLLLT','TLLLL............LLLLT','TTTTTTTTT.....TTTTTTTT','TTTTTTTTTTTDTTTTTTTTTT','TTTTTTTTTTTTTTTTTTTTTT'],
    ...
    pickups:[{pos:[11, 9],item:'kronensplitter',qty:1,requireType:'Feuer',requireDefeated:'kronenwaechter-schmiede',
      ...
      lockedMsg2:'🔒 Wächter Bram versperrt noch den Weg zur Esse.'}]
  },
  nebelmoor_ruinen:{
    name:'Versunkene Ruinen',parentArea:5,returnPos:[1,9],
    guardian:{key:'kronenwaechter-ruinen',pos:[11,10],name:'Wächter Sylre',lvl:42,
      team:[{id:'aquatlas',lvl:42}],pal:BOSS_PAL,
      intro:'Wächter Sylre: "Das Moor gibt nichts preis, das nicht erst erstritten wurde."',
      win:'Wächter Sylre: "Die Tiefe akzeptiert dich. Geh zum Altar."'},
    ...
    pickups:[{pos:[11, 9],item:'kronensplitter',qty:1,requireDefeated:'kronenwaechter-ruinen',
      lockedMsg2:'🔒 Wächter Sylre versperrt noch den Weg zum Altar.',
  ...
  meisterstadt_archiv:{
    ...
    guardian:{key:'kronenwaechter-archiv',pos:[11,6],name:'Wächter Osk',lvl:60,
      team:[{id:'faustitan',lvl:60}],pal:BOSS_PAL,
      intro:'Wächter Osk: "Vier Splitter, vier Prüfungen. Diese hier ist die letzte."',
      win:'Wächter Osk: "...Dann bist du bereit. Mehr, als du selbst weißt."'},
    rows:['TTTTTTTTTTTTTTTTTTTTTT','TTTTTTTTTTTTTTTTTTTTTT','TTTTTTTTTTTTTTTTTTTTTT','TTTT.......O.......TTT','TTTT.....O...O.....TTT','TTTT...............TTT','TTTT...............TTT','TTTTTTTTT.....TTTTTTTT','TTTTTT...........TTTTT','TTTTTTC.......O.TTTTTT','TTTTTT...........TTTTT','TTTTTT...........TTTTT','TTTTTT...........TTTTT','TTTTTT...........TTTTT','TTTTTTTT.......TTTTTTT','TTTTTTTT.......TTTTTTT','TTTTTTTT...D...TTTTTTT','TTTTTTTTTTTTTTTTTTTTTT'],
    spawn:[11, 15],ambient:[],
    npcs:[
      {n:'Archivarin Wesa',pos:[9, 11],
    ...
    pickups:[{pos:[11, 5],item:'kronensplitter',qty:1,requireDefeated:'kronenwaechter-archiv',
      lockedMsg2:'🔒 Wächter Osk versperrt noch den Weg zur Vitrine.',
  ...
  pfad_der_krone:{
    name:'Der Pfad der Krone',parentArea:7,parentLoc:'side',parentSideId:'meisterstadt_archiv',returnPos:[6,9],
    unlockCheck:()=>true,
...
function applySave(s){
  ...
  state.leadIdx=s.leadIdx||0;state.bag=s.bag||{bindungsstein:5};state.money=(s.money==null||isNaN(s.money))?600:s.money;
...
function tideWet(zoneChar){
  ...
  if(zoneChar==='s')return ph===2||ph===3;
  return false;
}
...
function checkTideCatch(){
  ...
  if((t==='Q'||t==='R'||t==='q'||t==='r'||t==='s')&&tideWet(t)){
...
function hierTrainers(){
  ...
  if(state.loc==='side'){
    ...
    if(sa&&sa.guardian)return [Object.assign({},sa.guardian,{kind:'boss',smart:true,dbl:false})];
    return [];
  }
  return [];
}
...
function drawTile(t,sx,sy,gx,gy){
  ...
  switch(t){
    ...
    case 'q': case 'r':{   // Lavafeld (Timing wie Gezeiten, andere Optik)
      ...
      break;}
    case 's':{   // Dritte Lavazone, eigener Zeittakt (versetzt zu q/r)
      const molten2=tideWet(t);
      wctx.fillStyle=molten2?'#8a2a6a':shade('#4a3a48',.86);
      wctx.fillRect(sx,sy,TILE+1,TILE+1);
      if(molten2){
        wctx.fillStyle='rgba(230,140,255,.4)';
        const o=Math.sin(wfx.t*4+gx*1.3)*2;
        wctx.fillRect(sx+3,sy+8+o,TILE-6,3);
      }else{
        wctx.strokeStyle='rgba(90,60,90,.5)';wctx.lineWidth=1;
        wctx.strokeRect(sx+3,sy+3,TILE-6,TILE-6);
      }
      break;}
...
function drawWorld(){
  ...
  if(state.loc==='protown'){
    ...
    ((sa&&sa.pickups)||[]).forEach(pu=>{
      const key='side:'+state.sideId+':'+pu.pos[0]+':'+pu.pos[1];
      if((state.found||[]).indexOf(key)>=0)return;
      const sx=Math.round((pu.pos[0]-camX)*TILE),sy=Math.round((pu.pos[1]-camY)*TILE);
      if(sx<-TILE*2||sy<-TILE*2||sx>VW*TILE+TILE||sy>VH*TILE+TILE)return;
      const pulse=Math.sin(wfx.t*3)*.5+.5;
      wctx.fillStyle='rgba(255,230,140,'+(.15+pulse*.25)+')';
      wctx.beginPath();wctx.arc(sx+11,sy+11,9+pulse*2,0,Math.PI*2);wctx.fill();
      wctx.fillStyle='rgba(255,245,200,'+(.5+pulse*.4)+')';
      const cx=sx+11,cy=sy+9-pulse*2;
      wctx.beginPath();
      wctx.moveTo(cx,cy-5);wctx.lineTo(cx+1.5,cy-1.5);wctx.lineTo(cx+5,cy);
      wctx.lineTo(cx+1.5,cy+1.5);wctx.lineTo(cx,cy+5);wctx.lineTo(cx-1.5,cy+1.5);
      wctx.lineTo(cx-5,cy);wctx.lineTo(cx-1.5,cy-1.5);wctx.closePath();wctx.fill();
    });
...
function checkSidePickup(x,y){
  ...
  if(pu.requireDefeated&&!isDone(pu.requireDefeated)){
    toast(pu.lockedMsg2||('🔒 Etwas hält dich noch zurück.'),3200);
    return;
  }
  state.found.push(key);
...
async function movePlayer(dx,dy){
  ...
  if(zt==='D'){
    if(state.loc==='side'){
      ...
      state.sideId=null;
      if(sa.parentLoc==='side'&&sa.parentSideId){
        state.sideId=sa.parentSideId;
        gotoLoc('side',pa,sa.returnPos,'◀ Zurück in '+SIDE_AREAS[sa.parentSideId].name);
      }else{
...
function effectiveCap(a){
  ...
  let hoechsteBezwungen=-1;
  for(let i=0;i<=7;i++){if(arenaCleared(i))hoechsteBezwungen=i;}
  if(hoechsteBezwungen<0)return AREA_DEFS[a].cap;
  const naechste=Math.min(hoechsteBezwungen+1,AREA_DEFS.length-1);
  return Math.max(AREA_DEFS[a].cap,AREA_DEFS[naechste].cap);
}
...
function renderMenu(){
  ...
  if(tab==='team'){
    ...
    h2.textContent='BESONDERER ORT';list.appendChild(h2);
    const rk=document.createElement('div');rk.className='row';
    rk.innerHTML=`<div class="rn"><b>Der Pfad der Krone</b><br>
      <span style="opacity:.7;font-size:9px">Direkt zu Hera</span></div><span>›</span>`;
    rk.onclick=()=>{
      state.sideId='pfad_der_krone';
      gotoLoc('side',7,SIDE_AREAS.pfad_der_krone.spawn,'🗺️ Direkt zum Pfad der Krone.');
    };
    list.appendChild(rk);
  }
  else if(tab==='quests'){
