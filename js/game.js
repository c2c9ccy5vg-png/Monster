...
const MOVES={
  ...
  rudelsturm:M('Rudelsturm','Normal',30),
  erdschlund:M('Erdschlund','Gift',28,{status:'gift',chance:.3}),
  wuestenzorn:M('Wüstenzorn','Stein',28,{debuff:'def',stages:1}),
  trugbild:M('Trugbild','Geist',28,{debuff:'atk',stages:1}),
  hydrabiss:M('Hydrabiss','Gift',28,{status:'gift',chance:.35}),
  hoellenbiss:M('Höllenbiss','Kampf',30),
  sturmgalopp:M('Sturmgalopp','Flug',30),
...
const SHOP_STOCK=['trank','supertrank','beleber','gegenmittel','bindungsstein','vertrauensstein','ahnenstein',
...
const MAPS=[
 ...
 {rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........PP.........T','T.....,,,.PP.,,,,....T','T...VV,,,.PP.,,,,VV..T','T.....U,,.PP.,,O,....T','T.........PP.........T','T.........PP.........T','T..O.....VPPPP....O..T','T.........PPPP.......T','T.........PPPP.......T','T.........PPV........T','T........PPP....,,,,.T','T.,,,,...PP.....VV,,.T','T.,,VV...PPP...U,,,,.T','T.,,,,O..PPP....,,,,.T','T.,,,,....PP......C..T','T.........PP.........T','TTTTTTTTTTTTTTTTTTTTTT'],
  spawn:[10,16],trainers:[[5,4],[16,4],[3,9],[18,9],[6,13]],boss:[10,2],rival:[15,12],legend:[2,13]},
 {rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........PP.........T','T.C.......PP.........T','T.O.......PP.......O.T','T..O......PP...LL.O..T','T......O..PP...LLLL..T','T.........PP...LLLL..T','T..LLLL...PP.........T','T..LLLL...PPP........T','T..LLLL...PPP........T','T........PPPP........T','T........PPP..LLL.L..T','T.......PPP...LLLLL..T','T.......PP....LLLLL..T','T...O...PPPP.......O.T','T.O.....PPPP.O.......T','T.........PP.........T','TTTTTTTTTTTTTTTTTTTTTT'],
  spawn:[10,16],trainers:[[4,4],[17,4],[8,6],[13,6],[4,11]],boss:[10,2],rival:[17,11]},
 {rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........PP.........T','T..,,,....PP.........T','T..,,,....PP.O.......T','T..,,,...PPP....OO...T','T..WWWW..PP.....O....T','T..WWWKK.PPPP........T','T..WWWW..PPPP.....U..T','T.........PPP........T','T.C.......PP...WWWW..T','T...OO..PPPP...KKWW..T','T...O...PPP....WWWW..T','T.......PPPP...WWW...T','T.....U.OPPP...,,,,..T','T........PPP..U,,,,..T','T........PP....,,,,..T','T........PPS.........T','TTTTTTTTTTTTTTTTTTTTTT'],
 ...
 {rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........PP.........T','T.........PP.........T','T.TT...VV.PP......TT.T','T.T......PPP..WWW..T.T','T.....O..PP...WKKO...T','T........PPP..WWWW...T','T...TT...PPP..WWWW...T','T.........PPP........T','T.........PPP........T','T........PPPP...TT...T','T........PPP.........T','T.TT....PPP.......TT.T','T.......PP..CVVO.....T','T...O...PPPP.........T','T.......PPPP.........T','T.........PP.........T','TTTTTTTTTTTTTTTTTTTTTT'],
  spawn:[10,16],trainers:[[4,4],[17,4],[8,6],[13,6],[4,11]],boss:[10,2],rival:[17,11]},
 {rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........PP.........T','T.........PP......C..T','T..O......PP......O..T','T.........PP.........T','T........VPPV........T','T.........PP.........T','T.....O...PP...O.....T','T.........PP.........T','T.........PP.........T','T.....O..PPP...O.....T','T........PP..........T','T........VP.V........T','T........PPP.........T','T..O.....PPP......O..T','T.........PP.........T','T.........PP.........T','TTTTTTTTTTTTTTTTTTTTTT'],
...
const state={team:[],box:[],leadIdx:0,bag:{bindungsstein:5,trank:2},money:600,
  ...
  events:[],npcSeen:[],legendClues:[],quests:{},sideId:null,legendCluePity:{},
...
const SIDE_LINK={
  ...
  '3:18:15':'donnersteppe_windmuehle',
  '4:2:2':'aschekrater_schmiede',
  '5:2:9':'nebelmoor_ruinen',
  '7:18:2':'meisterstadt_archiv',
...
const SIDE_AREAS={
  ...
  donnersteppe_windmuehle:{
    name:'Windmühlenruine',parentArea:3,returnPos:[18,14],
  ...
  aschekrater_schmiede:{
    name:'Verlassene Schmiede',parentArea:4,returnPos:[2,2],
  ...
  nebelmoor_ruinen:{
    name:'Versunkene Ruinen',parentArea:5,returnPos:[2,9],
  ...
  meisterstadt_archiv:{
    name:'Archiv der Ahnen',parentArea:7,returnPos:[18,2],
...
function snapshot(){
  return{v:6,team:state.team,box:state.box,leadIdx:state.leadIdx,bag:state.bag,money:state.money,
    ...
    events:state.events,npcSeen:state.npcSeen,legendClues:state.legendClues,quests:state.quests,sideId:state.sideId,legendCluePity:state.legendCluePity,
...
function applySave(s){
  ...
  state.events=s.events||[];state.npcSeen=s.npcSeen||[];state.legendClues=s.legendClues||[];state.quests=s.quests||{};state.sideId=s.sideId||null;state.legendCluePity=s.legendCluePity||{};
...
function ballCount(){return Object.keys(ITEMS).filter(k=>ITEMS[k].kind==='ball').reduce((s,k)=>s+(state.bag[k]||0),0);}
...
const FIND_POOL=['trank','bindungsstein','gegenmittel','supertrank','vertrauensstein','beleber','ueberreste'];
...
function showBalls(){
  ...
  const order=['bindungsstein','vertrauensstein','ahnenstein','glutstein','flutstein','wurzelstein','funkenstein','schleierstein','kernstein'];
  const keys=order.filter(k=>state.bag[k]>0);
  keys.forEach(k=>{
    const it=ITEMS[k],btn=document.createElement('button');
    const m=ballMult(k,e);
    const resoniert=it.matchType&&mTypes(e).includes(it.matchType);
    btn.innerHTML=it.name+' ×'+state.bag[k]+'<span class="mv-sub">Bindungsrate ×'+m+(resoniert?' ✨ Resonanz!':'')+'</span>';
    btn.onclick=()=>tryCatch(k);
    g.appendChild(btn);
  });
  const c=document.createElement('button');c.className='secondary span2';c.textContent='Zurück';
  c.onclick=()=>setActions('main');g.appendChild(c);
  setMsg('Welchen Stein einsetzen?');setActions('sub');
}
...
function renderMenu(){
  ...
  if(tab==='team'){
    ...
    const groups=[['ball','BINDUNGSSTEINE'],['heal','HEILUNG'],['cure','HEILUNG'],
      ['revive','HEILUNG'],['held','TRAGITEMS'],['relic','RELIKTE']];
    const shown={};
    ...
    [['HEILUNG',['heal','cure','revive']],['BINDUNGSSTEINE',['ball']],['TRAGITEMS',['held']],
