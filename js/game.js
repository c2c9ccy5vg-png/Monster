...
const ARENA_DEFS=[
 ...
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFF^B','BFFFFFFFFFFFFFFFFFFF^B','BFFFFFFFFFFFFFFFFFFF^B','BFFFFFFFFFFFFFFFFFFF^B','BFFFFFFFFFFFFFFFFFFF^B','BFFFFFFFFFFFFFFFFFFF^B','BFFFFFFFFFFFFFFFFFFF^B','BFFFFFFFFFFFFFFFFFFF^B','BFFFFFFFFFFFFFFFFFFF^B','B>>>>>>>>>>>>>>>>>>>^B','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[6,10],[15,10],[10,6]],boss:[10,2]},
 {rows:['BBBBBBBBBBBBBBBBBBBBBB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFSSSSSSSSSSSSSSSFFFB','BFFSSSSSSSSSSSSSSSFFFB','BFFSSSSSSSSSSSSSSSFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFMMMMMMMMMMMMMMMFFFB','BFFMMMMMMMMMMMMMMMFFFB','BFFMMMMMMMMMMMMMMMFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFFFFFFFFFFFFB','BFFFFFFFFFDDFFFFFFFFFB','BBBBBBBBBBBBBBBBBBBBBB'],
  pos:[[6,14],[15,14],[6,3],[15,3],[10,12]],boss:[10,2]},
...
const PROLOGUE_TOWN={
  name:'Lichthausen',
  rows:['TTTTTTTTTTTTTTTTTTTTTT','T.........NN.........T','T.........PP.........T','T...BBBBB.PP.........T','T...BBBBB.PP.........T','T...BBHBB.PP.........T','T....PP...PP.........T','T....PP...PP.........T','T.........PP.........T','T.........PP...M..C..T','T.........PP.........T','T.........PP.........T','T.........PP.........T','T.........PP.........T','T.........PP.........T','T.........PP.........T','T.........PP.........T','TTTTTTTTTTTTTTTTTTTTTT']
};
...
const SIDE_AREAS={
  bindungswiese:{
    name:'Bindungswiese',parentArea:0,parentLoc:'protown',returnPos:[18,10],
    spawn:[10,10],
...
function showBondingRitual(np){
  ...
  card.appendChild(cv);
  card.insertAdjacentHTML('beforeend',`<b>Bindungsritual</b><span class="mv-sub">mit ${DEX[id].name}</span>`);
  const go=()=>{
...
function tideWet(zoneChar){
  const ph=tidePhase();
  if(zoneChar==='Q'||zoneChar==='S')return ph===0||ph===1;
  if(zoneChar==='R'||zoneChar==='M')return ph===1||ph===2;
  return false;
}
...
function drawTile(t,sx,sy,gx,gy){
  ...
  switch(t){
    ...
    case 'Q': case 'R':{   // Gezeitenfeld
      ...
      break;}
    case 'S': case 'M':{   // Lavafeld (Timing wie Gezeiten, andere Optik)
